...
"F. Giải quyết vấn đề với sự trợ giúp của máy tính": [
    ...
    },
    {
        ...
        "answer": "Không, máy tính chỉ là công cụ thực hiện theo các bước lệnh do con người thiết kế and chỉ huy"
    },
    {
...
# =====================================================
    ...
    if st.session_state.question_index < total_questions:
        ...
        # =====================================================
        # XỬ LÝ LOGIC KHI HỌC SINH BẤM NÚT
        # =====================================================
        if btn_kiem_tra:
            if answer == q["answer"]:
...
st.markdown(
    """
    <div class='footer'>
    🌟 Học liệu số xây dựng bằng Python + Streamlit
    </div>
    """,
    unsafe_allow_html=True
)